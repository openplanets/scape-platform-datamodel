...
public abstract class ValidationUtil {
	...
	public static void validateTechMDRecord(TechnicalMetadata technical) {
		...
		if (technical.getMetadataType() == TechnicalMetadata.MetadataType.TEXTMD) {
			...
			assertNotNull(niso.getBasicImageInformation().getBasicImageCharacteristics().getPhotometricInterpretation()
					.getReferencedBlackWhite());
			...
			assertNotNull(niso.getBasicImageInformation().getBasicImageCharacteristics().getPhotometricInterpretation()
					.getSpecialFormatCharacteristics());
	...
	public static void validateXML(InputStream metsIn, InputStream schemaIn) throws Exception {
		...
		System.out.println("Validation resulted in\n" + h.getNumFatal() + " fatal errors\n" + h.getNumErrors() + " errors\n" + h.getNumWarnings() + " warnings");
	}
